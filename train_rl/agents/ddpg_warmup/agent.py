...
class Agent():
    def __init__(self, training_config, critic_config, memory_config, exploration_config, experiment_path, init_memory, il_agent_config):
        ...
        self.critic_warmup = training_config['critic_warmup']
        ...
        self.optimizer_critic = optimizer.Adam(self.critic.parameters(), lr=training_config['lr_critic'])
        self.optimizer_actor = optimizer.Adam(self.il_agent._model.parameters(), lr=training_config['lr_actor'])
