...
class ValeoAction(object):
    ...
    def get(self, terminal_reward):
        ...
        desired_spd_veh = desired_spd_ped  = desired_spd_stop = self.maximum_speed
        ...
        desired_speed = min(self.maximum_speed, desired_spd_veh, desired_spd_ped, desired_spd_stop)
        ...
        reward = r_position + r_rotation + terminal_reward + r_action
