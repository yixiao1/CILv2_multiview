...
class ObsManager(ObsManagerBase):
    ...
    def _define_obs_space(self):
        self.obs_space = spaces.Dict({
            'location': spaces.Box(low=-100, high=1000, shape=(self._steps, 3), dtype=np.float32),
    ...
    def get_observation(self):
        ...
        for i in range(self._steps):
            ...
            location_list.append([wp_location_actor_coord.x, wp_location_actor_coord.y, wp_location_actor_coord.z])
