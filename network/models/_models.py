...
from .architectures.CIL_multiview.CIL_multiview_tokens import CIL_multiview_tokens
from .architectures.CIL_multiview.CIL_multiview_TD_Diffusion import CIL_multiview_TD_Diffusion
...
class CILv2_multiview_tokens_attention(nn.Module):
    def __init__(self, params):
        super(CILv2_multiview_tokens_attention, self).__init__()
        self._model = CIL_multiview_tokens(params)
        self.name = g_conf.MODEL_TYPE
...
class CILv2_multiview_TD_Diffusion_attention(nn.Module):
    def __init__(self, params):
        super(CILv2_multiview_TD_Diffusion_attention, self).__init__()
        self._model = CIL_multiview_TD_Diffusion(params)
        self.name = g_conf.MODEL_TYPE
    ...
    def forward(self, src_images, src_directions, src_speeds, targets=None):
        return self._model.forward(src_images, src_directions, src_speeds, targets=targets)
