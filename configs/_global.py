...
_g_conf.MASK_DIAGONAL_ATTMAP = False  # From: https://arxiv.org/abs/2112.13492
...
_g_conf.LEARNABLE_DYN_TRAF_LOSS_RATIO = False  # Ratio of Dynamic/Traffic heads in the MHA block
_g_conf.DYN_TRAF_RATIO_START = 0.5  # Initial ratio of Dynamic/Traffic heads in the MHA block
_g_conf.DYN_TRAF_RATIO_LR_MULTIPLIER = 100.0  # Multiplier for the learning rate for the ratio of Dynamic/Traffic ratio parameter
