...
* Download our collected datasets:
    ...
    For model training, please unzip them in to $DATASET_PATH. The dataloader will access to the full paths $DATASET_PATH/<dataset folder name>,
    where <dataset folder name> will be defined by `TRAIN_DATASET_NAME` in the [exp yaml file](https://github.com/yixiao1/CILv2_multiview/blob/main/configs/CILv2/CILv2_3cam_smalltest.yaml)
