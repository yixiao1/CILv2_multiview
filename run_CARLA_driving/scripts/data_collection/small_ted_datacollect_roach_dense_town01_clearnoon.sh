...
data_collection_dense_roachRL_Town01_clearnoon () {
    python ${DRIVING_TEST_ROOT}/driving/evaluator.py \
    --debug=0 \
    --scenarios=${DRIVING_TEST_ROOT}/data/data_collection/ted_small_Town01_dense_clearnoon.json  \
...
function_array=("data_collection_dense_roachRL_Town01_clearnoon")
