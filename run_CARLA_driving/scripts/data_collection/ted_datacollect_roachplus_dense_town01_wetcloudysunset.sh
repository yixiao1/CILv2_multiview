...
ted_data_collection_dense_roachRLplus_Town01_clearnoon () {
    python ${DRIVING_TEST_ROOT}/driving/evaluator.py \
    --debug=0 \
    --scenarios=${DRIVING_TEST_ROOT}/data/data_collection/ted_training_Town01_dense_wetcloudysunset.json  \
    ...
    --fps=10 \
    --PedestriansSeed=5 \
    --trafficManagerSeed=5 \
    --data-collection
}

function_array=("ted_data_collection_dense_roachRLplus_Town01_clearnoon")
