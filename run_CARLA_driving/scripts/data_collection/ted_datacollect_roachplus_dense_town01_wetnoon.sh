...
ted_data_collection_dense_roachRLplus_Town01_wetnoon () {
    python ${DRIVING_TEST_ROOT}/driving/evaluator.py \
    --debug=0 \
    --scenarios=${DRIVING_TEST_ROOT}/data/data_collection/ted_training_Town01_dense_wetnoon.json  \
...
function_array=("ted_data_collection_dense_roachRLplus_Town01_wetnoon")
