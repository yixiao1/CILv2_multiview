...
data_collection_dense_roachRL_Town01_hardrainnoon () {
    python ${DRIVING_TEST_ROOT}/driving/evaluator.py \
    --debug=0 \
    --scenarios=${DRIVING_TEST_ROOT}/data/data_collection/training_Town01_dense_hardrainnoon.json  \
...
function_array=("data_collection_dense_roachRL_Town01_hardrainnoon")
