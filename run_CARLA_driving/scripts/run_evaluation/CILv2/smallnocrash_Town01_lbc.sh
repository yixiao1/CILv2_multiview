...
nocrash_newweathertown_busy_small () {
    ...
    --debug=0 \
    --scenarios=${DRIVING_TEST_ROOT}/data/nocrash/nocrash_newweather_dense_small_Town01_lbc.json  \
    ...
    --agent-config=${TRAINING_RESULTS_ROOT}/_results/CIL_ViT/CILvit_3cam_vitb32_Town01Full_bs256_fPE_wmupcdown_lr1e4_preACT_noCLS/config50.json \
