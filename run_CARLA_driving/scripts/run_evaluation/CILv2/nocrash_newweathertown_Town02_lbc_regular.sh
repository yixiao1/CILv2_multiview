...
nocrash_newweathertown_regular () {
    ...
    --agent-config=${TRAINING_RESULTS_ROOT}/_results/CIL_ViT_oneseq/CILv2_3cam_vitb32_Town01Full_oneseq_bs256_fPE_wmupcdown_lr1e4_preACT_noCLS_out2MLPbig_hres/config70.json \
...
function_array=("nocrash_newweathertown_regular")
